...
class QuotesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        reviews = response.css(
            'div#wrap.lang-en>div.biz-country-us>div.main-content-wrap>div#super-container>div.container>div.clearfix>div.column>div>div.feed>div.review-list>ul>li')
        with open('content.txt', 'a') as fout:
            for review in reviews[1: len(reviews)]:
                ...
                upvotes = review.css(
                    'div.review>div.review-wrapper>div.review-footer>div.rateReview>ul.voting-buttons>li.vote-item>a.ybtn>span.count::text').extract()
                upvotes = ' '.join(upvotes).encode('utf-8')
                user = review.css(
                    'div.review>div.review-sidebar>div.review-sidebar-content>div.ypassport>div.media-story>ul>li.user-name>a::attr(href)').extract()[
                    0].encode('utf-8')
                star = review.css(
                    'div.review>div.review-wrapper>div.review-content>div.biz-rating>div>div::attr(title)').extract()[
                    0].encode('utf-8')
    ...
    def get_all_pages(self, response):
        pages = response.css(
            'div#wrap.lang-en>div.biz-country-us>div.main-content-wrap>div#super-container>div.container>div.clearfix>div.column>div>div.feed>div.review-pager>div.pagination-block>div.arrange>div.pagination-links>div.arrange')
        # print next_page
